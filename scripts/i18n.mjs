...
const manualTranslations = {
  zh: {
    ...
    "settings.ui.backendTransport": "后端传输方式",
    "settings.ui.enableSystemNotifications": "启用系统通知",
    "settings.ui.sharedMemory": "共享内存",
    "settings.ui.themeColor": "主题色",
    "settings.ui.themeColorInvalid": "请输入 #RRGGBB 格式的主题色。",
    "settings.ui.themeColorReset": "重置主题色",
    "settings.ui.transportSwitchFailed": "传输方式切换失败",
    "settings.ui.transportSwitchedSharedMemory": "已切换到共享内存",
    "settings.ui.transportSwitchedWebSocket": "已切换到 WebSocket",
    "settings.ui.transportSwitching": "正在切换",
    "settings.ui.webSocket": "WebSocket",
  ...
  en: {
    ...
    "settings.ui.backendTransport": "Backend transport",
    "settings.ui.enableSystemNotifications": "Enable system notifications",
    "settings.ui.sharedMemory": "Shared Memory",
    ...
    "settings.ui.transportSwitchFailed": "Transport switch failed",
    "settings.ui.transportSwitchedSharedMemory": "Switched to Shared Memory",
    "settings.ui.transportSwitchedWebSocket": "Switched to WebSocket",
    "settings.ui.transportSwitching": "Switching",
    "settings.ui.webSocket": "WebSocket",
...
Object.assign(manualTranslations.fr, {
  ...
  "notification.script.failedBody": "{{task}} s'est arrete anormalement. Code de sortie : {{exitCode}}.",
...
Object.assign(manualTranslations.ko, {
  ...
  "notification.script.failedBody": "{{task}} 작업이 비정상 종료되었습니다. 종료 코드: {{exitCode}}.",
