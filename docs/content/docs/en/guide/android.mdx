...
Starting from v0.0.7, BAAS Tauri ships a native Android client. It bundles the frontend UI, Python backend runtime, updater, Shizuku installer, and foreground service into one APK for Android-local automation and testing.
...
| --- | --- | --- |
| Shizuku running and authorized | Creates the background game display and injects input | Game preview and controls are unavailable |
...
3. Shizuku is running and BAAS is authorized.
...
| Script cannot click | Check Shizuku state and the background game display |
