...
<Callout type="warn" title="Validate the display first">
  The PC client must keep a 16:9 image ratio. A stretched window, enabled HDR, an occluded game
  window, or a window moved outside the screen can break recognition and clicking.
</Callout>
