...
<div className="baas-doc-home">
  <section className="baas-doc-intro">
    ...
    <div className="baas-doc-actions">
      ...
      <a href="./guide/android">Android 客户端</a>
...
<Cards className="baas-doc-focus-cards">
  ...
  <Card
    ...
    title="Android 客户端"
    href="./guide/android"
    description="安装 APK、启用无障碍服务、保持前台服务，并使用通知栏脚本开关。"
  />
  <Card
...
| Android 端   | [Android 客户端](./guide/android)       | APK、权限、前台服务、通知栏开关        |
...
| 查看更新     | [版本历史](./reference/release-history) | 当前版本变化、影响范围和升级建议       |
